    ...
    <div className="min-h-screen bg-white text-gray-900 dark:bg-slate-950 dark:text-white transition-colors duration-300">
      <div className="border-b border-gray-200 bg-white dark:border-slate-800 dark:bg-slate-950/90 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <span className="text-xs text-gray-600 dark:text-slate-400">{t('upi.awarenessPage.title')}</span>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-7">
        <div className="rounded-3xl border border-gray-200 bg-white dark:border-slate-800 dark:bg-slate-900/80 p-7 transition-colors duration-300">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-2">{t('upi.awarenessPage.title')}</h1>
              <p className="text-gray-700 dark:text-slate-400 leading-relaxed">{t('upi.awarenessPage.desc')}</p>
            </div>
          </div>
        </div>

        <div className="grid gap-5 lg:grid-cols-3">
          <AwarenessCard title={t('upi.awarenessPage.card1Title')} color="red" items={[
          ...
          <AwarenessCard title={t('upi.awarenessPage.card2Title')} color="green" items={[
          ...
          <AwarenessCard title={t('upi.awarenessPage.card3Title')} color="cyan" items={[
