...
export default function IdentityTheft() {
  ...
  return (
    <TopicLayout icon="🪪" title={t("awareness.identity.title")} accentColor="#f87171"
      subtitle={t("awareness.identity.subtitle")}>
      <AwarenessCard title={t("awareness.identity.card1Title")} color="red" items={[
      ...
      <AwarenessCard title={t("awareness.identity.card2Title")} color="green" items={[
      ...
      <AwarenessCard title={t("awareness.identity.card3Title")} color="cyan" items={[
