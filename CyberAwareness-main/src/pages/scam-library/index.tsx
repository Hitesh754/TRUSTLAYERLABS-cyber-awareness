    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="border-b border-slate-800 bg-slate-950/90 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <span className="text-xs text-slate-400">{t('scamLibrary.breadcrumb')}</span>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
          ...
          <div className="rounded-xl p-4 text-center bg-slate-900 border border-slate-800">
            ...
            <div className="text-xs text-slate-500">{t('scamLibrary.other')}</div>
          </div>
        </div>
        ...
        <div>
          ...
          {filteredScams.length > 0 ? (
            ...
            <div className="rounded-xl p-12 text-center bg-slate-900 border border-slate-800">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">{t('scamLibrary.noScamsFound')}</h3>
              <p className="text-sm text-slate-500">{t('scamLibrary.noScamsFoundDesc')}</p>
            </div>
          )}
        </div>
        ...
        <div className="rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-5"
          ...
          <div>
            <div className="font-bold text-base text-white mb-1">{t('scamLibrary.victimTitle')}</div>
            <p className="text-sm text-slate-500">{t('scamLibrary.victimDesc')}</p>
          </div>
