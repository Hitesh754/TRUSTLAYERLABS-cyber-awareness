/**
 * @deprecated Legacy SOC-style laws dashboard — not routed.
 * Canonical hub: `/laws` → `CyberLawCommandCenter` via `pages/laws/index.tsx`.
 * Kept for reference and safe rollback.
 */
import { Link } from "react-router-dom";
import "./css/laws.css";

export default function LawsLegacyDashboard() {
  return (
    <main className="law-shell">
      <nav className="law-nav" aria-label="Cyber law navigation">
        <Link className="brand-link" to="/laws">
