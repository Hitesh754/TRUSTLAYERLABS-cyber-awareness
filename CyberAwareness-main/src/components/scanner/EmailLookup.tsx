              ...
              <div className="p-5 bg-red-950/10 border border-red-900/30 rounded-xl space-y-4">
                ...
                <div className="space-y-4">
                  {result.breaches.map((breach, index) => (
                    <div key={index} className="p-4 bg-slate-900 border border-slate-850 rounded-lg">
                      <div className="flex justify-between items-start">
                        <h4 className="font-bold text-white text-sm">{breach.name}</h4>
            ...
            <div className="p-5 bg-gradient-to-t from-slate-950 to-slate-900 border border-slate-850 rounded-xl">
              ...
              <ul className="text-xs text-slate-300 space-y-2.5 list-inside list-disc">
                {result.riskLevel === 'HIGH' ? (
                  <>
                    <li className="text-red-300">**Critical**: Change password immediately if you use this password on multiple sites.</li>
                  ...
                  <>
                    <li className="text-amber-300">**Credentials hygiene**: Ensure you use unique passwords for primary and social networks.</li>
                    <li>**De-clutter**: Revoke login access of this email address to services you no longer actively use.</li>
                  </>
                ) : (
                  <>
                    <li className="text-emerald-300">**Good standing**: Continue keeping a strong password policy and monitor periodic activity alerts.</li>
                  </>
                )}
              </ul>
            </div>
