        ...
        {result && !loading && (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-5 bg-slate-800/40 border border-slate-800 rounded-xl">
              <div>
                <p className="text-slate-400 text-xs uppercase tracking-wider">{t('phoneLookup.subscriberNumber')}</p>
            ...
            <div className="p-5 bg-slate-800/30 border border-slate-800/60 rounded-xl">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h3 className="text-sm font-semibold text-white">{t('phoneLookup.spamRiskIndex')}</h3>
                  <p className="text-xs text-slate-400 mt-0.5">{t('phoneLookup.spamRiskDesc')}</p>
                </div>
            ...
            <div className="p-5 bg-slate-900 border border-slate-850 rounded-xl space-y-4">
              <div className="flex items-center gap-2 border-b border-slate-800 pb-2.5">
                ...
                <h3 className="text-sm font-semibold text-white">{t('phoneLookup.kycSection')}</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3">
                  ...
                  <div>
                    <p className="text-slate-400 text-xs">{t('phoneLookup.ownerName')}</p>
                ...
                <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3">
                  ...
                  <div>
                    <p className="text-slate-400 text-xs">{t('phoneLookup.aadhaarStatus')}</p>
                ...
                <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3 md:col-span-2">
                  ...
                  <div>
                    <p className="text-slate-400 text-xs">{t('phoneLookup.registeredAddress')}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3">
                ...
                <div>
                  <p className="text-slate-400 text-xs">{t('phoneLookup.carrierNetwork')}</p>
              ...
              <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3">
                ...
                <div>
                  <p className="text-slate-400 text-xs">{t('phoneLookup.hlrCircle')}</p>
              ...
              <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3">
                ...
                <div>
                  <p className="text-slate-400 text-xs">{t('phoneLookup.reportedAlias')}</p>
              ...
              <div className="p-4 bg-slate-850 border border-slate-800 rounded-xl flex gap-3">
                ...
                <div>
                  <p className="text-slate-400 text-xs">{t('phoneLookup.reportsActive')}</p>
            ...
            <div className="p-5 bg-gradient-to-t from-slate-950 to-slate-900 border border-slate-850 rounded-xl">
              <h4 className="text-sm font-semibold text-white mb-3">{t('phoneLookup.securityActions')}</h4>
